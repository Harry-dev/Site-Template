...
// Render an ACF image field using ID
// if '$img is not empty' is TRUE run wp_get_att ($ID, SIZE) while if it is FALSE return string
echo !empty($img) ? wp_get_attachment_image($img['ID'], 'masthead') : 'Img failed';
